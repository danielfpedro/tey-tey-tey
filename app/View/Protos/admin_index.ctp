...
<td class="text-center" style="width: 90px;vertical-align: middle;">
			<?php echo $this->Html->link('<span class=\'glyphicon glyphicon-pencil\'></span>', array('action' => 'edit', $proto['Proto']['id']), array('class'=> 'btn btn-sm btn-primary tt', 'title'=> 'Editar', 'escape'=> false)); ?>
			<?php echo $this->Form->postLink('<span class=\'glyphicon glyphicon-remove\'></span>', array('action' => 'delete', $proto['Proto']['id']), array('class'=> 'btn btn-sm btn-danger tt', 'title'=> 'Remover','escape'=> false), __('Are you sure you want to delete # %s?', $proto['Proto']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
			</tbody>
