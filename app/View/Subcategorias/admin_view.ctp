...
<h2><?php echo __('Subcategoria'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($subcategoria['Subcategoria']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($subcategoria['Subcategoria']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
...
<div class="related">
	...
	<?php if (!empty($subcategoria['Estabelecimento'])): ?>
	...
	<?php foreach ($subcategoria['Estabelecimento'] as $estabelecimento): ?>
		<tr>
