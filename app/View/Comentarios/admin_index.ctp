...
<!-- 	<h3>Comentarios</h3>
	...
	<div class="row">
		...
		<div class="col-sm-6 col-md-3 col-xs-12 col-md-offset-6 text-right">
			<?php
	$label = '<span class=\'glyphicon glyphicon-plus\'></span> Novo comentario';
...
?>
	...
	<tr>
		<td style='vertical-align: middle;'><?php echo h($comentario['Comentario']['id']); ?>&nbsp;</td>
		<td style='vertical-align: middle;'><?php echo h($comentario['Comentario']['name']); ?>&nbsp;</td>
		<td style='vertical-align: middle;'><?php echo h($comentario['Comentario']['created']); ?>&nbsp;</td>
		<td style='vertical-align: middle;'><?php echo h($comentario['Comentario']['modified']); ?>&nbsp;</td>
		...
		<td class="text-center" style="width: 90px;vertical-align: middle;">
			...
			<?php echo $this->Html->link('<span class=\'glyphicon glyphicon-pencil\'></span>', array('action' => 'edit', $comentario['Comentario']['id']), array('class'=> 'btn btn-sm btn-primary', 'title'=> 'Editar', 'escape'=> false)); ?>
			<?php echo $this->Form->postLink('<span class=\'glyphicon glyphicon-remove\'></span>', array('action' => 'delete', $comentario['Comentario']['id']), array('class'=> 'btn btn-sm btn-danger', 'title'=> 'Remover','escape'=> false), __('Are you sure you want to delete # %s?', $comentario['Comentario']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
			</tbody>
